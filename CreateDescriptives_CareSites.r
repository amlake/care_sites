...
## @Allie: Added this step to get CPT names for supplemental data 5 
cptinfo_anno <- cptcount_bycaresite %>% distinct(concept_code,concept_name)
fwrite(cptinfo_anno, file="/data/davis_lab/allie/care_sites/output/SpecialtyPrediction/cptcode_conceptnames.txt", quote=F)
